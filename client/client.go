...
//GetCookies Work arround to get client cookies
func (c *Client) GetCookies(ctx context.Context, method, urlStr string, body interface{}) ([]*http.Cookie, error) {
	...
	transCfg := &http.Transport{
		TLSClientConfig: &tls.Config{InsecureSkipVerify: c.Credentials.Insecure},
	}
...
//GetTaskStatus
func (c *Client) GetTaskStatus(ctx context.Context, method, urlStr string, v interface{}) (error){
...
func (c *Client) NewRequest(ctx context.Context, method, urlStr string, cookies []*http.Cookie, body interface{}) (*http.Request, error) {
